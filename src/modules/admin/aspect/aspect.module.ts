...
import { AspectService } from 'src/shared/services/aspect/aspect.service';
import { AspectRepository } from 'src/shared/services/aspect/aspect.repository';
...
@Module({
  ...
  providers: [
    ...
    AspectService, AspectRepository
  ],
})
